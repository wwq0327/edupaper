...
但当我们翻看全国各省的信息技术教材时，我们不难发现，教学所用的操作系统为Windows，文字处理使用的是MS Word，网页制作使用FrontPage，浏览器使用Internet explorer，邮件处理使用Outlook express，演示使用MS Powerpoint，程序设计使用Visual Basic，如此等等。
